 ...
 * @return a GF2D rect
 */
Rect gf3d_rect(float x, float y, float z, float w, float h, float d);
 ...
 * @param r the rect to base it on
 */
Shape gf3d_shape_from_sdl_rect(SDL_Rect r);
...
/**
 * @brief make a shape based on a gf3d Circle
...
/**
 * @brief make a shape based on a gf3d Edge
...
/**
 * @brief set all parameters of a gf3d rect at once
...
/**
 * @brief set all the parameters of a gf3d circle at once
 * @param
 */
#define gf3d_circle_set(circle,a,b,c) (circle.x = a,circle.y = b, circle.r = c)
 ...
 * @param r the gf3d rect to convert
 * @return an SDL rect
 */
SDL_Rect gf3d_rect_to_sdl_rect(Rect r);

/**
 * @brief convert an SDL Rect to a gf3d rect
 ...
 */
#define gf3d_edge_set(e,a,b,c,d) (e.x1 = a,e.y1 = b, e.x2 = c, e.y2 = d)
 ...
 */
#define gf3d_edge_copy(dst,src) (dst.x1 = src.x1,dst.y1 = src.y1,dst.x2 = src.x2,dst.y2 = src.y2)
 ...
 * @return true if there is an intersection, false otherwise
 */
Uint8 gf3d_edge_circle_intersection_poc(Edge e,Circle c,Vector3D *poc,Vector3D *normal);
