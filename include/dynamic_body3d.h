#ifndef __DYNAMIC_BODY3D_H__
#define __DYNAMIC_BODY3D_H__
...
typedef struct
{
    ...
    Vector3D    position;       /**<temp position during update*/
    Vector3D    velocity;       /**<scaled velocity based on space step*/
